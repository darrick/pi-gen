...
install -D -m 755 usr/local/libexec/pulseaudio-module-xrdp/load_pa_modules.sh "${ROOTFS_DIR}"/usr/local/libexec/pulseaudio-module-xrdp/
...
install -D -m 644 etc/skel/.config/systemd/user/pulseaudio.service "${ROOTFS_DIR}"/etc/skel/.config/systemd/user/pulseaudio.service
